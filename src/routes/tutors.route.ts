...
export default async function(fastify: FastifyInstance): Promise<void> {
  ...
  fastify.post('/:id/follow', { preHandler: [fastify.authenticate] }, async (request: FastifyRequest, reply: FastifyReply) => {
    try {
  ...
  fastify.delete('/:id/follow', { preHandler: [fastify.authenticate] }, async (request: FastifyRequest, reply: FastifyReply) => {
    try {
  ...
  fastify.post('/actions/email-students', { preHandler: [fastify.authenticate] }, async (request: FastifyRequest, reply: FastifyReply) => {
    try {
  ...
  fastify.post('/actions/post-update', { preHandler: [fastify.authenticate] }, async (request: FastifyRequest, reply: FastifyReply) => {
    try {
  ...
  fastify.post('/actions/schedule-office-hour', { preHandler: [fastify.authenticate] }, async (request: FastifyRequest, reply: FastifyReply) => {
    try {
