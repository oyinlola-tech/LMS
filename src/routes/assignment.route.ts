...
export default async function(fastify: FastifyInstance): Promise<void> {
  ...
  fastify.get('/course/:courseId', { preHandler: [fastify.authenticate] }, async (request: FastifyRequest, reply: FastifyReply) => {
    try {
  ...
  fastify.get('/module/:moduleId', { preHandler: [fastify.authenticate] }, async (request: FastifyRequest, reply: FastifyReply) => {
    try {
  ...
  fastify.get('/:id/details', { preHandler: [fastify.authenticate] }, async (request: FastifyRequest, reply: FastifyReply) => {
    try {
      const { id } = request.params as IdParams;
      const result = await getAssignmentDetailQuery.execute(id, request.user!.sub, request.user!.role);
      return ok(reply, result, 'Assignment loaded');
  ...
  fastify.post('/:id/start', { preHandler: [fastify.authenticate] }, async (request: FastifyRequest, reply: FastifyReply) => {
    try {
      const { id } = request.params as IdParams;
  ...
  fastify.post('/:id/submit', { preHandler: [fastify.authenticate] }, async (request: FastifyRequest, reply: FastifyReply) => {
  ...
  fastify.post('/:id/submit-upload', { preHandler: [fastify.authenticate, handleFileUpload] }, async (request: FastifyRequest, reply: FastifyReply) => {
  ...
  fastify.get('/:id/submission', { preHandler: [fastify.authenticate] }, async (request: FastifyRequest, reply: FastifyReply) => {
    try {
      const { id } = request.params as IdParams;
  ...
  fastify.get('/:id/attempts', { preHandler: [fastify.authenticate] }, async (request: FastifyRequest, reply: FastifyReply) => {
    try {
      const { id } = request.params as IdParams;
  ...
  fastify.get('/:id/submissions/me', { preHandler: [fastify.authenticate] }, async (request: FastifyRequest, reply: FastifyReply) => {
    try {
      const { id } = request.params as IdParams;
      const result = await getMySubmissionQuery.execute(id, request.user!.sub);
      return ok(reply, result, 'Submission loaded');
  ...
  fastify.put('/:id/submissions/:submissionId', { preHandler: [fastify.authenticate] }, async (request: FastifyRequest, reply: FastifyReply) => {
    try {
  ...
  fastify.get('/:id/submissions', { preHandler: [fastify.authenticate] }, async (request: FastifyRequest, reply: FastifyReply) => {
    try {
      const { id } = request.params as IdParams;
  ...
  fastify.get('/:id/submissions/:submissionId', { preHandler: [fastify.authenticate] }, async (request: FastifyRequest, reply: FastifyReply) => {
    try {
      const { id, submissionId } = request.params as IdSubmissionIdParams;
  ...
  fastify.get('/:id/submissions/:submissionId/download', { preHandler: [fastify.authenticate] }, async (request: FastifyRequest, reply: FastifyReply) => {
    try {
      const { id, submissionId } = request.params as IdSubmissionIdParams;
