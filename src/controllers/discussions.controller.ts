...
export async function listDiscussionThreads(request: FastifyRequest, reply: FastifyReply) {
  try {
...
export async function getDiscussionThread(request: FastifyRequest, reply: FastifyReply) {
  try {
...
export async function createDiscussionThread(request: FastifyRequest, reply: FastifyReply) {
  try {
...
export async function createDiscussionReply(request: FastifyRequest, reply: FastifyReply) {
  try {
