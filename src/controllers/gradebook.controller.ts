...
export async function getStudentDetail(request: FastifyRequest, reply: FastifyReply) {
  try {
...
export async function gradeSubmission(request: FastifyRequest, reply: FastifyReply) {
  try {
