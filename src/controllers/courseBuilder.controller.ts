...
export const listCourses = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
...
export const getCourse = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
...
export const updateCourse = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
...
export const updateModule = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
...
export const reorderModules = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
...
export const updateLesson = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
...
export const deleteLesson = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
...
export const reorderLessons = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
    const { order } = (request.body as Record<string, any>) || {};
    if (!Array.isArray(order)) return error(reply, 400, 'VALIDATION_ERROR', 'order must be an array');
...
export const addLessonContent = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
...
export const uploadResource = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
    const uploadedFile = (request as any).uploadedFile;
    if (!publicBaseUrl || !uploadedFile) return error(reply, 400, 'VALIDATION_ERROR', 'file is required');
    const ext = path.extname(uploadedFile.filename).replace('.', '').toLowerCase();
...
export const setLessonMediaUrl = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
...
export const createAssignment = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
...
export const updateAssignment = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
...
export const deleteAssignment = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
...
export const publishCourse = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
...
export const unpublishCourse = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
...
export const createQuiz = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
...
export const getCoursePreview = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
...
export const getEnrollmentPreview = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
