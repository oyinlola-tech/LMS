...
export const getFeatured = async (_request: FastifyRequest, reply: FastifyReply) => {
  try {
...
export const getDepartments = async (_request: FastifyRequest, reply: FastifyReply) => {
  try {
...
export const getPreview = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
...
export const getCurriculum = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
    const { id } = request.params as IdParams;
...
export const getPricing = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
    const { id } = request.params as IdParams;
...
export const getDetail = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
    const { id } = request.params as IdParams;
    const userId = request.user?.sub;
...
export const enroll = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
    const { id } = request.params as IdParams;
...
export const getCommentReplies = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
