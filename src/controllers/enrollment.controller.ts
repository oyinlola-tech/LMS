...
export const getResume = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
...
export const listEnrollments = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
...
export const getEnrollmentDetail = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
...
export const completeEnrollment = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
    const { id } = request.params as IdParams;
