...
export const getLesson = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
...
export const completeLesson = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
    const { id } = request.params as IdParams;
...
export const getBookmarks = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
    const { id } = request.params as IdParams;
...
export const createBookmark = async (request: FastifyRequest, reply: FastifyReply) => {
...
export const deleteBookmark = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
...
export const getQuiz = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
    const { id } = request.params as IdParams;
...
export const submitQuiz = async (request: FastifyRequest, reply: FastifyReply) => {
