...
export const getCourseModules = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
...
export const getAssignmentForEdit = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
...
export const saveDetails = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
    const { id } = request.params as { id: string };
    const body = request.body as any;
...
export const saveSubmissionConfig = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
    const { id } = request.params as { id: string };
    const body = request.body as any;
...
export const addResource = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
    const { id } = request.params as { id: string };
    const body = request.body as any;
...
export const removeResource = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
    const { resourceId } = request.params as { resourceId: string };
...
export const publishAssignment = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
    const { id } = request.params as { id: string };
...
export const saveDraft = async (request: FastifyRequest, reply: FastifyReply) => {
  try {
    const { id } = request.params as { id: string };
    const body = request.body as any;
    if (body.details) {
