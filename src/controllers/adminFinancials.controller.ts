...
export async function getFinancialOverview(_request: FastifyRequest, reply: FastifyReply) {
  try {
...
export async function updatePayout(request: FastifyRequest, reply: FastifyReply) {
...
export async function getPlatformSettings(request: FastifyRequest, reply: FastifyReply) {
...
export async function updatePlatformSettings(request: FastifyRequest, reply: FastifyReply) {
  if (!hasPermission(request.user?.role, 'manage_platform_settings')) {
